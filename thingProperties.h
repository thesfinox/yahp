...
void initProperties(){
  ...
  ArduinoCloud.addProperty(nebulizerButton, READWRITE, ON_CHANGE, onNebulizerButtonChange);
  ArduinoCloud.addProperty(nebulizerSwitch, READWRITE, ON_CHANGE, onNebulizerSwitchChange);
  ArduinoCloud.addProperty(nebulizing, READ, ON_CHANGE, NULL);
